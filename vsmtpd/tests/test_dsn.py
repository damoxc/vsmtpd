...
class DSNTestCase(TestCase):
    ...
    def test_dsn_method(self):
        ...
        self.assertEqual(dsn._dsn('I can break the rules too.', None, dsn.DENY, 5, 2),
                         (901, 'I can break the rules too. (#5.5.2)'))

        self.assertEqual(dsn._dsn(None, None, dsn.DENYSOFT, 18, 34),
